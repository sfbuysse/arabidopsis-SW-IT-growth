...
The goal of this code is to read in Basia's leaf number and rosette area data collected on Native lines of *Arabidopsis thaliana* in current and future SW chamber common gardens from Nov 2024 - Feb 2025. All leaf counts were done on live plants. All rosette area was collected from imageJ outlines of top down rosette photos.
...
```
Area does have some lines that decrease... mistakes? double check them.
...
Preliminary figures showing changes in mean growth over time - these should give us a good idea of what the final plots may look like from the models.
```{r}
